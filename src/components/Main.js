...
export default function Main() {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center bg-yellow-300 h-[90vh] p-5 md:justify-between">
      ...
      <div className="flex flex-col justify-center items-center space-y-4 md:space-y-6 w-full md:w-1/2 text-center">
        ...
        <div className="text-xl w-3/4 md:w-1/2 text-black">
